...
const Environmental = () => {
  ...
  return (  
    ...
    <Background>
      ...
      {/*<!--그래프--> */}
            <div className="fpa_graph_box_env">
                ...
                <div className="fpa_graph_view_w100 pos_left">
                    <div className="fpa_graph_box_title"><span className="title">온도 &amp; 습도</span></div>
                    <div className="fpa_graph">
                        <div id="visit1" className='visit'>
                        {tempGraph.length  > 0 ?
                            <EnvChart labels={dateStr} label1={'온도'} label2={'습도'} data11={tempGraph} data12={tempGraph2} data13={tempGraph3} data21={humiGraph} data22={humiGraph2} data23={humiGraph3} theme={me && me.theme === 'dark'? 'dark':'light'}/> : <div
                ...
                <div className="fpa_graph_view_h50 pos_left">
                    ...
                    <span className="title">미세먼지 &amp; 초미세먼지</span></div>
                    <div className="fpa_graph">
                        <div id="visit2" className='visit'>
                            {dustGraph.length > 0 ?
                            <EnvDustChart tChart labels={dateStr} label1={'미세먼지'} label2={'초미세먼지'} data11={dustGraph} data12={dustGraph2} data13={dustGraph3} data21={ultraDustGraph} data22={ultraDustGraph2} data23={ultraDustGraph3} theme={me && me.theme === 'dark'? 'dark':'light'}/> : <div
                                style={{ height: "300px"}}></div>}
                        </div>
                    </div>
                </div>
                ...
                <div className="fpa_graph_view_h50 pos_right2 ">
                    <div className="fpa_graph_box_title">
                        <span className="title">TVOC</span></div>
                    <div className="fpa_graph">
                        <div id="visit" className='visit'>
                            {tvocGraph.length > 0 ?
                            <EnvTvocChart labels={dateStr} data1={tvocGraph} data2={tvocGraph2} data3={tvocGraph3} theme={me && me.theme === 'dark'? 'dark':'light'} /> : <div style={{ height: "300px"}}></div>}
                        </div>
                    </div>
                </div>
                </div>
      ...
      <NavBottom value={'4'} theme={me && me.theme === 'dark'? 'dark':'light'}/>
      </div>
    </Background>
