...
const EnvDustChart = ({labels, label1, label2, data11, data12, data13, data21, data22, data23, theme}) => {// lables: x축   label은 툴팁에 나오는 내용 data: y축
  const barChartData = {
    labels: labels, //x축 이름
    datasets: [
      {
